...
public class BankingApplication {
    ...
    public enum Command {
        CREATE, Write, BALANCE, CHECK, TRANSACTIONS, WIREDEPOSIT, DIRECTDEPOSIT, REGISTER, CHARGE, INVALID_COMMAND;
            ...
            switch (/* 4. Get the command */ Command.toStr(input[0].toUpperCase())) {
                ...
                case CHECK: {
                    if (input.length == 3) {
                        ...
                        System.out.println(
                                "Check Number or Amount is missing. Please use the Command 'write [Check Number] [Amount]'");
                    break;
                }
                case BALANCE: {
                    if (input.length == 1)
                ...
                case CHARGE: {
                    if (input.length == 3) {
                        ...
                        System.out.println("Charge Number or Amount is missing. Please use the Command 'charge [Charge Number] [Amount]'");
                    break;
                }
                case INVALID_COMMAND: {
                    System.out.println("Invalid Command. Commands - CREATE, WRITE, WIREDEPOSIT, DIRECTDEPOSIT, BALANCE, TRANSACTIONS, CHARGES, REGISTER");
                    break;
                }
            }
        }
    ...
    public void processWriteCommand(int chkNum, double chkAmount, String date, Account account) {
        ...
        switch (isValid) {
            case Constants.CHARGE_TRANSACTION:
                System.out.println("CREDITCARD charge #" + chkNum + " for $" + chkAmount + " written");
                break;
            case Constants.TRANSACTION_WRITTEN:
                System.out.println("Check #" + chkNum + " for $" + chkAmount + " written");
                break;
            ...
            case Constants.DUPLICATE_TRANSACTION_NUMBER:
                System.out.println("Check number #" + chkNum + " is already used");
                break;
